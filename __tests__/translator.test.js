...
describe("Translator - translate", () => {
  test.skip("google translator - translate", async () => {
    const text = "Hello";
    const sourceLang = "en";
    const targetLang = "es";
  ...
  test.skip("bing translator - translate", async () => {
    const text = "Hello";
    const sourceLang = "en";
    const targetLang = "es";
  ...
  test.skip("deepl translator - translate", async () => {
    const text = "Hello";
    const sourceLang = "en";
    const targetLang = "es";
  ...
  test.skip("yandex translator - translate", async () => {
    const text = "Hello";
    const sourceLang = "en";
    const targetLang = "es";
  ...
  test.skip("papago translator - translate", async () => {
    const text = "Hello";
    const sourceLang = "en";
    const targetLang = "es";
