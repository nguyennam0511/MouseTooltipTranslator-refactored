...
function getGoogleDocSelection() {
  ...
  var iframeDocument = document.querySelector(".docs-texteventtarget-iframe")?.contentDocument;
  var textBox = iframeDocument?.querySelector("[contenteditable=true]");
  ...
  //get select text
  var text = "";
  iframeDocument?.querySelectorAll("span").forEach(function (span) {
