...
async function initPdf() {
  checkPdfError();
  await dom_util.waitDocumentReady(); //wait dom load
...
function insertLineBreak() {
  ...
  document.querySelectorAll(".page span:not(:has(*))").forEach(function (line, index) {
    //skip empty line
...
function initButton() {
  ...
  button.id = "toolbarAddon";
  button.className = "toolbarButton";
  button.title = "Reader Mode options1";
